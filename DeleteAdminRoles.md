...
* **Sample GET:** (With URL Encoded `token`)
	...
	```HTML
	http://api.tasscloud.com.au/tassweb/api/?appcode=API23&v=3&method=DeleteAdminRoles&token=3w6XHPP1j163aHf%2FHRAnLA%3D%3D&company=10
	```
...
* **Sample POST:**
	...
	<form id="postForm" name="postForm" method="POST" action="http://api.tasscloud.com.au/tassweb/api/">
		<input type="hidden" name="method" value="DeleteAdminRoles" />
